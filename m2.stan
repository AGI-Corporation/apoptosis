...
transformed parameters {
  ...
  // Bolt ⚡: Hoist exponentiation of clone-level parameters outside the observation loop
...
generated quantities {
  ...
  // Bolt ⚡: kq_vec, td_vec, kd_vec are already in scope from transformed parameters
